...
const programs = [
  {
    ...
    description:
      "Monthly strategy dossiers distilling macro regime shifts, regulatory signals, and digital asset market structure for boards and investment committees.",
  },
  {
    title: "Digital Asset Readiness Labs",
    description:
      "Collaborative design sprints aligning operating models, governance controls, and technology integrations to accelerate capability build-outs.",
  },
  {
    title: "Risk & Resilience Simulations",
    description:
      "Scenario exercises pressure-testing liquidity, counterparty, and policy shocks with action plans mapped to institutional playbooks.",
  },
];

const ecosystem = [
  {
    title: "Policy Observatories",
    detail: "Active dialogue with regulators, industry bodies, and policy institutes to anticipate rulemaking trajectories.",
  },
  {
    title: "Technology Collaboratives",
    detail: "Solution partners across custody, execution, DeFi infrastructure, and data engineering to accelerate implementation.",
  },
  {
    title: "Academic Alliances",
    detail: "Research fellows and domain experts contributing to model validation, experimentation, and governance standards.",
  },
];
...
export default function Page() {
  return (
    <div className="space-y-24">
      ...
      <section className="container-xl space-y-10">
        <div className="max-w-3xl space-y-4">
          <p className="eyebrow">Programmes</p>
          <h2 className="heading-lg text-ink">Structured initiatives that extend beyond project delivery.</h2>
          <p className="copy-lg">
            Our programmes connect executive teams with curated research, immersive simulations, and guided implementation so that
            insights convert into institutional muscle memory.
          </p>
        </div>
        <div className="grid gap-6 md:grid-cols-3">
          {programs.map((program) => (
            <div key={program.title} className="card h-full">
              <h3 className="heading-md text-ink text-2xl">{program.title}</h3>
      ...
      <section className="relative overflow-hidden rounded-[40px] border border-black/10 bg-[#14100E] text-white">
        ...
        <div className="relative container-xl py-20 space-y-10">
          <p className="eyebrow text-white/70">Leadership Dialogue</p>
          <blockquote className="max-w-3xl space-y-6">
            <p className="heading-lg text-white">
              &ldquo;Institutions succeed when insight, governance, and technology operate as a single system. Our mandate is to
              orchestrate that alignment so that clients navigate structural change with confidence.&rdquo;
            </p>
            <footer className="text-sm text-white/70">Aureon Capital Executive Committee</footer>
          </blockquote>
        </div>
      </section>
      ...
      <section className="container-xl space-y-10">
        <div className="max-w-3xl space-y-4">
          ...
          <h2 className="heading-lg text-ink">A connected community amplifying outcomes.</h2>
          <p className="copy-lg">
            Our work is reinforced by a curated ecosystem of partners who contribute to market intelligence, product design, and
