...
*Educational use only; not investment advice.*
  ...
  {
    slug: "higher-inflation-regime-portfolio-implications",
    title: "A New Era of Higher Inflation Risks",
    date: "2025-10-05",
    excerpt: "Why structural forces point to persistent inflation pressures and how portfolios can adapt to the regime shift.",
    content: `
...
In the decade following the Global Financial Crisis, a rare alignment of disinflationary forces — globalization, China’s export dominance, the U.S. shale revolution, and persistent demand weakness — anchored global inflation well below central bank targets. That environment is now gone.
